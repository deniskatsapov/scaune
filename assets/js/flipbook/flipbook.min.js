    ...
    (function init(jQuery, window, document, undefined) {
        ...
        FLIPBOOK.Main = function (options, elem) {
            ...
            if (self.options.singlePageMode) {
                if (self.options.viewMode != '2d' && self.options.viewMode != 'swipe') self.options.viewMode = '3d'
            }
        ...
        FLIPBOOK.Main.prototype = {
            ...
            loadPage: function (index, size, callback) {
                ...
                if (this.options.pdfMode) {
                    ...
                    if (!this.options.pages[index].img) {
                        ...
                        this.options.pages[index].img = document.createElement('img')
                        ...
                        if (this.options.viewMode == "webgl")
                            this.options.pages[index].img.crossOrigin = 'Anonymous'

                        this.options.pages[index].img.src = this.options.pages[index].src

                    } else if (this.options.pages[index].imgLoaded) {

                        self.pageLoaded({ index: index, size: size, image: self.options.pages[index].img, htmlContent: self.options.pages[index].htmlContent }, callback)
            ...
            onBookCreated: function () {
                ...
                document.addEventListener("keydown", function (e) {
                    ...
                    if (!self.isZoomed() && self.bodyHasVerticalScrollbar() && !self.options.lightBox && !self.fullscreenActive && self.options.arrowsDisabled)
                        return
            ...
            initSwipe: function () {
                ...
                window.jQuery(this.bookLayer).swipe({
                    ...
                    pinchStatus: function (event, phase, direction, distance, duration, fingerCount, pinchZoom) {
                        ...
                        if (fingerCount > 1 && self.options.isMobile)
                            event.preventDefault()

                        if (phase == "start")
                            self.zoomStart = self.zoom

                        if (fingerCount > 1 && self.options.viewMode == "webgl")
            ...
            handleFsChange: function () {
                ...
                if (document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || this.isFullscreen) {
                    ...
                    self.btnExpand.find("." + self.btnExpand.icon).hide()
                    self.btnExpand.find("." + self.btnExpand.iconAlt).show()
                    ...
                    self.btnExpand.find("." + self.btnExpand.icon).show()
                    self.btnExpand.find("." + self.btnExpand.iconAlt).hide()
            ...
            createBookmark: function () {
                ...
                this.createMenuHeader(this.bookmark, this.strings.bookmark, this.toggleBookmark)
            ...
            createToc: function (tocArray) {
                ...
                this.createMenuHeader(this.toc, this.strings.tableOfContent, this.toggleToc)
